...
const navItems = [
  { href: "/dashboard", label: "Dashboard", icon: "fa-house", exact: true },
  { href: "/alumnos", label: "Los alumnos", icon: "fa-users" },
  { href: "/seguimientos", label: "Seguimientos", icon: "fa-clipboard-list" },
  { href: "/activity", label: "Mi actividad", icon: "fa-chart-bar", exact: true },
  { href: "/profil", label: "Mi perfil", icon: "fa-circle-user", exact: true },
];
