    ...
    <div className="border border-zinc-400 rounded-lg w-full overflow-x-auto text-myzinc">
      <table className="min-w-full divide-y divide-zinc-200 rounded-lg overflow-hidden">
        <thead className="bg-zinc-200 text-myzinc w-full">
          <tr>
            <th className="px-2 md:px-6 py-3 text-sm lg:text-md text-left text-xs font-bold uppercase tracking-wider">
            ...
            <th className="px-2 md:px-6 py-3 text-sm lg:text-md text-left text-xs font-bold uppercase tracking-wider0">
        ...
        <tbody className=" divide-y divide-zinc-200">
          {registeredVolunteers.map((reg) => (
            <tr key={reg.registrationId} className="hover:bg-zinc-50">
              <td className="px-2 md:px-6 py-4 text-sm lg:text-md whitespace-nowrap">
                {reg.firstName}{" "}
                {reg.lastName}
              </td>
              <td className="px-2 md:px-6 py-4 text-sm lg:text-md whitespace-nowrap">
